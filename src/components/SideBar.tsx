import { HomeIcon, ChartBarIcon, EnvelopeIcon, CreditCardIcon, BellIcon, ArrowUpIcon, ArrowTopRightOnSquareIcon} from "@heroicons/react/20/solid"
import { DocumentMagnifyingGlassIcon } from "@heroicons/react/24/solid"

const SideBar = () => {
  return (
    <div className='bg-slate-800 flex-none w-14 sm:w-20 h-screen'>
        <div className="h-20 items-center flex sm:flex-row">
